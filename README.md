...
**NOTE**: More configuration files are included in the [sample directory](/skx/kpie/tree/master/samples/).
...
Included within the repository is a sample configuration file, [dump.lua](/skx/kpie/tree/master/samples/dump.lua), which is designed to be a helpful starting point if you wish to script the manipulation of your windows.
